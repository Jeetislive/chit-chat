      ...
      <div className="relative w-full max-w-md animate-slideUp">
        <div className="glass-strong rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-1 text-sm">Sign in to continue chatting</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="username" className="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-1.5">
                Username
              </label>
              <input
                id="username"
